AI-Powered E-Commerce Application (Flutter + Node.js + RAG)
...
Node.js + Express Backend (AWS EC2)
        |
        ├── MongoDB (User, Product, Orders, Cart)
        ├── Stripe Payment Gateway
        └── AI Assistant Service (Python + RAG Pipeline)
                |
                ├── Vector Store (FAISS)
                ├── Redis Cache
...
Features
	...
	•	Search products
	•	Filter & sort by price, category, relevance
	•	Wishlist
	•	Add/remove products
