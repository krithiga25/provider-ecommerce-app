...
import grpc.rag_service_pb2 as rag__service__pb2 # type: ignore
...
class RagServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAnswer = channel.unary_unary(
                '/RagService/GetAnswer',
                request_serializer=rag__service__pb2.QueryRequest.SerializeToString,
                response_deserializer=rag__service__pb2.AnswerResponse.FromString,
...
def add_RagServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAnswer': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=rag__service__pb2.AnswerResponse.SerializeToString,
            ),
    }
...
class RagService(object):
    ...
    def GetAnswer(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            rag__service__pb2.AnswerResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
